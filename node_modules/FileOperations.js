 ...
 * @param callback
 */
FileOperations.prototype.copyFile = function (srcpath, dstpath, time, callback) {
    // source file
    ...
    readable.on('end', function () {
        if(timeid) {
            ...
            // finish copy, remember set fileLength to 0
            this.fileLength = 0;
        }
    });
};
...
FileOperations.prototype.filesize = function (filepath, callback) {
    ...
    // path process.cwd() + '/conf/shells/fileSize.bat '
    //{cwd: __dirname}
    var result;
    var command = execFile('fileSize.bat', [filepath], {cwd: 'E:/work/开源项目/Toki/Toki_development/conf/shells'}, function (err, stdout, stderr) {
        if (err || stderr) {
...
FileOperations.prototype.filesizeSync = function () {
